...
theorem subsampling_eps_le {p eps_rdp : ℚ} (_hp_pos : 0 < p) (hp_le : p ≤ 1) (heps_nonneg : 0 ≤ eps_rdp) :
...
theorem subsampling_amplification_factor_rational {p k : ℚ} (_hp_pos : 0 < p) (hp_le : p ≤ 1) (hk_pos : 0 < k) :
  p * k ≤ k := by
  nlinarith [hp_le, hk_pos]
