...
- Date (UTC): 2026-08-04
- Branch: `fix/theorem1-bft-compositional` (merged with `main`, which had
  already merged `fix/theorem7-8-pqc-hardness`, `fix/theorem2-rdp-sorries`,
  and `feat/formal-verification-phase0`)
- Commands executed:
