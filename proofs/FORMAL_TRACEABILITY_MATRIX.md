...
| --- | --- | --- | --- |
| `proofs/bft_resilience.md` (Theorem 1) | `LeanFormalization/Theorem1BFT.lean` | `theorem1_single_tier_resilient`, `theorem1_half_bound_of_forall`, `theorem1_four_ninths_of_half_bound`, `theorem1_inductive_safety`, `theorem1_global_bound_checked`, `theorem1_ten_million_corollary`, `theorem1_hierarchical_additivity`, `theorem1_scale_limit_check` | `internal/multikrum_test.go::TestMultiKrumSelect`, `internal/aggregator_multikrum_test.go::TestProcessGradientBatchWithMultiKrum` |
