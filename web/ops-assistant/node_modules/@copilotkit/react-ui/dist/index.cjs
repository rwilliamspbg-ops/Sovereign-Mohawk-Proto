...
const CloseIcon$1 = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	fill: "none",
	viewBox: "0 0 24 24",
	strokeWidth: "1.5",
...
const HeaderCloseIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	fill: "none",
	viewBox: "0 0 24 24",
	strokeWidth: "1.5",
...
const SendIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	fill: "none",
	viewBox: "0 0 24 24",
	strokeWidth: "1.5",
...
const MicrophoneIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	fill: "none",
	viewBox: "0 0 24 24",
	strokeWidth: "1.5",
...
const StopIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	fill: "none",
	viewBox: "0 0 24 24",
	strokeWidth: "1.5",
...
const RegenerateIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	fill: "none",
	viewBox: "0 0 24 24",
	strokeWidth: "2",
...
const CopyIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	fill: "none",
	viewBox: "0 0 24 24",
	strokeWidth: "2",
...
const SmallSpinnerIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
...
const SpinnerIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
	className: "copilotKitSpinner",
	style: {
		width: "24px",
		height: "24px"
...
const ActivityIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
	style: {
		display: "flex",
		alignItems: "center",
		gap: "4px"
...
const ThumbsUpIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	fill: "none",
	viewBox: "0 0 24 24",
	strokeWidth: "2",
...
const ThumbsDownIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	fill: "none",
	viewBox: "0 0 24 24",
	strokeWidth: "2",
...
const DownloadIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	fill: "none",
	viewBox: "0 0 24 24",
	strokeWidth: "2",
...
const UploadIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	fill: "none",
	viewBox: "0 0 24 24",
	strokeWidth: "1.5",
...
const ChatContext = react.default.createContext(void 0);
function useChatContext() {
	const context = react.default.useContext(ChatContext);
...
const ChatContextProvider = ({ labels, icons, children, open, setOpen }) => {
	const memoizedLabels = (0, react.useMemo)(() => ({
		initial: "",
		title: "CopilotKit",
	...
	const memoizedIcons = (0, react.useMemo)(() => ({
		openIcon: OpenIcon,
...
const Window = ({ children, clickOutsideToClose, shortcut, hitEscapeToClose }) => {
	const windowRef = react.default.useRef(null);
	...
	const handleKeyDown = (0, react.useCallback)((event) => {
		...
		else if (event.key === shortcut && ((0, _copilotkit_shared.isMacOS)() && event.metaKey || !(0, _copilotkit_shared.isMacOS)() && event.ctrlKey) && (!isInput || isDescendantOfWrapper)) setOpen(!open);
	}, [
		hitEscapeToClose,
		shortcut,
		open,
	...
	const adjustForMobile = (0, react.useCallback)(() => {
...
function logReadables(context) {
	...
	const readables = context.getContextString([], _copilotkit_react_core.defaultCopilotContextCategories).trim();
...
const ExclamationMarkTriangleIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
	width: "13.3967723px",
	height: "12px",
...
const ExclamationMarkIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
	width: "14px",
	height: "14px",
	viewBox: "0 0 14 14",
	version: "1.1",
...
const CheckIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
	width: "14px",
	height: "14px",
	viewBox: "0 0 14 14",
	version: "1.1",
...
function CopilotKitHelpModal() {
	const [showHelpModal, setShowHelpModal] = (0, react.useState)(false);
	...
	const HelpButton = () => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
		ref: buttonRef,
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: "relative",
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(HelpButton, {}), showHelpModal && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			ref: popoverRef,
...
function CopilotDevConsole() {
	const currentVersion = _copilotkit_shared.COPILOTKIT_VERSION;
	const context = (0, _copilotkit_react_core.useCopilotContext)();
	const [showDevConsole, setShowDevConsole] = (0, react.useState)(false);
	(0, react.useEffect)(() => {
		setShowDevConsole((0, _copilotkit_react_core.shouldShowDevConsole)(context.showDevConsole));
	}, [context.showDevConsole]);
	const dontRunTwiceInDevMode = (0, react.useRef)(false);
	const [versionStatus, setVersionStatus] = (0, react.useState)("unknown");
	const [latestVersion, setLatestVersion] = (0, react.useState)("");
	const consoleRef = (0, react.useRef)(null);
	const [debugButtonMode, setDebugButtonMode] = (0, react.useState)("full");
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(VersionInfo, {
				showDevConsole: context.showDevConsole,
				versionStatus,
				currentVersion,
				latestVersion
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(CopilotKitHelpModal, {}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(DebugMenuButton, {
				setShowDevConsole,
				checkForUpdates,
...
function DebugMenuButton({ setShowDevConsole, checkForUpdates, mode }) {
	const context = (0, _copilotkit_react_core.useCopilotContext)();
	const messagesContext = (0, _copilotkit_react_core.useCopilotMessagesContext)();
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_headlessui_react.Menu, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_headlessui_react.MenuButton, {
		className: `copilotKitDebugMenuTriggerButton ${mode === "compact" ? "compact" : ""}`,
		children: mode == "compact" ? "Debug" : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: ["Debug ", ChevronDownIcon] })
	}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_headlessui_react.MenuItems, {
		transition: true,
		anchor: "bottom end",
		className: "copilotKitDebugMenu",
		style: { zIndex: 40 },
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_headlessui_react.MenuItem, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
...
const Header = ({}) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: labels.title }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: "copilotKitHeaderControls",
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(CopilotDevConsole, {}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
...
const CodeBlock = (0, react.memo)(({ language, value }) => {
	const { isCopied, copyToClipboard } = useCopyToClipboard({ timeout: 2e3 });
	const [SyntaxHighlighter, setSyntaxHighlighter] = (0, react.useState)(() => react_syntax_highlighter.Light);
	(0, react.useEffect)(() => {
		try {
			setSyntaxHighlighter(() => react_syntax_highlighter.Prism);
		} catch {
			setSyntaxHighlighter(() => react_syntax_highlighter.Light);
		}
	}, []);
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SyntaxHighlighter, {
			language,
...
const defaultComponents = {
	...
	code({ children, className, inline, ...props }) {
		if (Array.isArray(children) && children.length) {
			if (children[0] == "▍") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				style: {
		...
		if (!hasLanguage && !hasNewlines) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", {
	...
	h2: ({ children, ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", {
		className: "copilotKitMarkdownElement",
		...props,
		children
	}),
	h3: ({ children, ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
		className: "copilotKitMarkdownElement",
		...props,
		children
	}),
	h4: ({ children, ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("h4", {
		className: "copilotKitMarkdownElement",
		...props,
		children
	}),
	h5: ({ children, ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("h5", {
		className: "copilotKitMarkdownElement",
		...props,
		children
	}),
	h6: ({ children, ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("h6", {
		className: "copilotKitMarkdownElement",
		...props,
		children
	}),
	...
	pre: ({ children, ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("pre", {
		className: "copilotKitMarkdownElement",
		...props,
		children
	}),
	blockquote: ({ children, ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("blockquote", {
		className: "copilotKitMarkdownElement",
		...props,
		children
	}),
	ul: ({ children, ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
		className: "copilotKitMarkdownElement",
		...props,
		children
	}),
	li: ({ children, ...props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
		className: "copilotKitMarkdownElement",
		...props,
		children
	})
...
const AssistantMessage = (props) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
		renderBefore ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			style: { marginBottom: "0.5rem" },
			children: subComponent
		}) : null,
		content && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: "copilotKitMessage copilotKitAssistantMessage",
			children: [content && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Markdown, {
				content,
				components: markdownTagRenderers
			}), content && !isLoading && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					onThumbsUp && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					onThumbsDown && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
		...
		renderAfter ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			style: { marginBottom: "0.5rem" },
			children: subComponent
		}) : null,
		isLoading && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LoadingIcon, {})
	] });
};
...
function RenderMessage({ UserMessage: UserMessage$3 = UserMessage, AssistantMessage: AssistantMessage$3 = AssistantMessage, ImageRenderer: ImageRenderer$2 = ImageRenderer, ...props }) {
	...
	switch (message.role) {
		case "user": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(UserMessage$3, {
			rawData: message,
			"data-message-role": "user",
			message,
			ImageRenderer: ImageRenderer$2
		}, index);
		case "assistant": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AssistantMessage$3, {
...
const LegacyRenderMessage = ({ message, messages, inProgress, index, isCurrentMessage, actionResult, AssistantMessage, UserMessage, ImageRenderer, onRegenerate, onCopy, onThumbsUp, onThumbsDown, markdownTagRenderers, legacyProps }) => {
	...
	const deprecatedMessage = (0, _copilotkit_runtime_client_gql.aguiToGQL)(message)[0] ?? void 0;
	if (deprecatedMessage.isTextMessage() && RenderTextMessage) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RenderTextMessage, {
		message,
		messages,
		inProgress,
		index,
	...
	if (deprecatedMessage.isActionExecutionMessage() && RenderActionExecutionMessage) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RenderActionExecutionMessage, {
		messages,
		message,
		inProgress,
		index,
	...
	if (deprecatedMessage.isAgentStateMessage() && RenderAgentStateMessage) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RenderAgentStateMessage, {
		messages,
		message,
		inProgress,
		index,
	...
	if (deprecatedMessage.isResultMessage() && RenderResultMessage) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RenderResultMessage, {
		messages,
		message,
		inProgress,
		index,
	...
	if (deprecatedMessage.isImageMessage() && RenderImageMessage) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RenderImageMessage, {
		messages,
		message,
		inProgress,
		index,
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RenderMessage, {
		messages,
		message,
		inProgress,
		index,
...
const Messages = ({ inProgress, children, RenderMessage, AssistantMessage, UserMessage, ErrorMessage, ImageRenderer, onRegenerate, onCopy, onThumbsUp, onThumbsDown, messageFeedback, markdownTagRenderers, chatError, RenderTextMessage, RenderActionExecutionMessage, RenderAgentStateMessage, RenderResultMessage, RenderImageMessage }) => {
	...
	const legacyProps = (0, react.useMemo)(() => ({
		RenderTextMessage,
		RenderActionExecutionMessage,
	...
	const MessageRenderer = hasLegacyProps ? (props) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LegacyRenderMessage, {
		...props,
		legacyProps
	}) : RenderMessage;
	const LoadingIcon = () => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: icons.activityIcon });
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [
				messages.map((message, index) => {
					return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MessageRenderer, {
						message,
						messages,
						inProgress,
						index,
...
function useScrollToBottom(messages) {
	...
	const isUserScrollUpRef = (0, react.useRef)(false);
...
const usePushToTalk = ({ sendFunction, inProgress, mediaType = "audio/mp4" }) => {
	...
	const recordedChunks = (0, react.useRef)([]);
	const generalContext = (0, _copilotkit_react_core.useCopilotContext)();
	const messagesContext = (0, _copilotkit_react_core.useCopilotMessagesContext)();
	const context = {
		...generalContext,
		...messagesContext
	};
	const [startReadingFromMessageId, setStartReadingFromMessageId] = (0, react.useState)(null);
	(0, react.useEffect)(() => {
	...
	(0, react.useEffect)(() => {
		if (inProgress === false && startReadingFromMessageId) {
			...
			playAudioResponse((0, _copilotkit_runtime_client_gql.gqlToAGUI)(context.messages).slice(lastMessageIndex + 1).filter((message) => message.role === "assistant").map((message) => message.content).join("\n"), context.copilotApiConfig.textToSpeechUrl, audioContextRef.current);
...
const Input = ({ inProgress, onSend, chatReady = false, onStop, onUpload, hideStopButton = false }) => {
	...
	const copilotContext = (0, _copilotkit_react_core.useCopilotContext)();
	...
	const { buttonIcon, buttonAlt } = (0, react.useMemo)(() => {
		if (!chatReady) return {
	...
	const { interrupt } = (0, _copilotkit_react_core.useCopilotChatInternal)();
	const canSend = (0, react.useMemo)(() => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(AutoResizingTextarea, {
				ref: textareaRef,
				...
				children: [
					onUpload && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						onClick: onUpload,
						className: "copilotKitInputControlButton",
						children: context.icons.uploadIcon
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { style: { flexGrow: 1 } }),
					showPushToTalk && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
		...
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PoweredByTag, { showPoweredBy })]
	});
};
...
function Suggestion({ title, onClick, partial, className }) {
	const { isLoading } = (0, _copilotkit_react_core.useCopilotChatInternal)();
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
		...
		type: "button",
		children: partial ? SmallSpinnerIcon : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: title })
	});
}
...
function Suggestions({ suggestions, onSuggestionClick, isLoading }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: suggestions.map((suggestion, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Suggestion, {
...
function CopilotChat({ instructions, suggestions = "auto", onSubmitMessage, makeSystemMessage, disableSystemMessage, onInProgress, onStopGeneration, onReloadMessages, onRegenerate, onCopy, onThumbsUp, onThumbsDown, markdownTagRenderers, Messages: Messages$2 = Messages, RenderMessage: RenderMessage$1 = RenderMessage, RenderSuggestionsList = Suggestions, Input: Input$2 = Input, className, icons, labels, AssistantMessage: AssistantMessage$2 = AssistantMessage, UserMessage: UserMessage$2 = UserMessage, ImageRenderer: ImageRenderer$1 = ImageRenderer, ErrorMessage, imageUploadsEnabled, inputFileAccept = "image/*", attachments, hideStopButton, observabilityHooks, renderError, onError, RenderTextMessage, RenderActionExecutionMessage, RenderAgentStateMessage, RenderResultMessage, RenderImageMessage }) {
	...
	const triggerObservabilityHook = (0, react.useCallback)((hookName, ...args) => {
		...
		if (observabilityHooks?.[hookName] && !publicApiKey) {
			setBannerError(new _copilotkit_shared.CopilotKitError({
				...
				severity: _copilotkit_shared.Severity.CRITICAL,
				visibility: _copilotkit_shared.ErrorVisibility.BANNER
			}));
			_copilotkit_shared.styledConsole.publicApiKeyRequired("observabilityHooks");
		}
	}, [
		publicApiKey,
		observabilityHooks,
	...
	const triggerChatError = (0, react.useCallback)((error, operation, originalError) => {
		...
		if (observabilityHooks?.onError && !publicApiKey) {
			...
			_copilotkit_shared.styledConsole.publicApiKeyRequired("observabilityHooks.onError");
		}
	}, [
		publicApiKey,
		chatApiEndpoint,
	...
	const { messages, isLoading, sendMessage, stopGeneration, reloadMessages, suggestions: currentSuggestions, isLoadingSuggestions, agent } = (0, _copilotkit_react_core.useCopilotChatInternal)({
		suggestions,
		onInProgress,
		onSubmitMessage,
		onStopGeneration,
	...
	const prevIsLoading = (0, react.useRef)(isLoading);
	(0, react.useEffect)(() => {
	...
	const chatContext = react.default.useContext(ChatContext);
...
function WrappedCopilotChat({ children, icons, labels, className }) {
	if (!react.default.useContext(ChatContext)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChatContextProvider, {
		icons,
		labels,
		open: true,
		setOpen: () => {},
...
const CopilotModalInner = ({ observabilityHooks, onSetOpen, clickOutsideToClose, hitEscapeToClose, shortcut, className, children, Window, Button, Header, ...chatProps }) => {
	const { copilotApiConfig, setBannerError } = (0, _copilotkit_react_core.useCopilotContext)();
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button, {}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Window, {
			...
			shortcut,
			hitEscapeToClose,
			children: [memoizedHeader, /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CopilotChat, {
				...chatProps,
				observabilityHooks
			})]
		})]
...
const CopilotModal = ({ instructions, defaultOpen = false, clickOutsideToClose = true, hitEscapeToClose = true, onSetOpen, onSubmitMessage, onStopGeneration, onReloadMessages, shortcut = "/", icons, labels, makeSystemMessage, onInProgress, Window: Window$1 = Window, Button: Button$1 = Button, Header: Header$1 = Header, Messages: Messages$1 = Messages, Input: Input$1 = Input, AssistantMessage: AssistantMessage$1 = AssistantMessage, UserMessage: UserMessage$1 = UserMessage, onThumbsUp, onThumbsDown, onCopy, onRegenerate, markdownTagRenderers, className, children, observabilityHooks, ...props }) => {
	const [openState, setOpenState] = react.default.useState(defaultOpen);
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChatContextProvider, {
		icons,
		labels,
		open: openState,
		setOpen: setOpenState,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CopilotModalInner, {
			observabilityHooks,
			onSetOpen,
...
function CopilotPopup(props) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CopilotModal, {
		...props,
...
function CopilotSidebar(props) {
	...
	const [expandedClassName, setExpandedClassName] = (0, react.useState)(props.defaultOpen ? "sidebarExpanded" : "");
...
exports.RenderSuggestionsList = Suggestions;
