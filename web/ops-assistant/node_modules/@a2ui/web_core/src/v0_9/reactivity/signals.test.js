...
import { signal as aSignal, computed as aComputed, isSignal, } from '@angular/core';
describe('FrameworkSignal', () => {
    ...
    describe('Angular variation', () => {
        const AngularSignal = {
            computed: (fn) => aComputed(fn),
            isSignal: (val) => isSignal(val),
            wrap: (val) => aSignal(val),
            unwrap: (val) => val(),
    ...
    describe('Preact variation', () => {
        const PreactSignal = {
            computed: (fn) => pComputed(fn),
            isSignal: (val) => val instanceof PSignal,
            wrap: (val) => new PSignal(val),
            unwrap: (val) => val.value,
