...
export async function queryPrometheus(
  ...
  try {
    ...
    throw new Error(
      `Failed to query Prometheus: ${error instanceof Error ? error.message : 'Unknown error'}`
    );
  }
}
...
export async function queryPrometheusRange(
  ...
  try {
    ...
    throw new Error(
      `Failed to query Prometheus range: ${error instanceof Error ? error.message : 'Unknown error'}`
    );
  }
}

export async function queryPrometheusHealth(): Promise<boolean> {
  try {
