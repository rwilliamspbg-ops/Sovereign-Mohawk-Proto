...
class FederationShardingArchitecture:
    ...
    def __init__(
        self,
        total_nodes: int,
        max_federation_size: int = 1_000_000,
...
def scaling_analysis():
    ...
    for net_size in network_sizes:
        ...
        print(
            f"  Convergence time: {spec['global_metrics']['estimated_convergence_time_days']:.0f} days"
        )
        print(
            f"  Total communication: {spec['global_metrics']['estimated_total_communication_gb']:.0f}GB"
        )
        print()
