...
class GradientCompressor:
    ...
    def compress_topk(
        self, gradients: List[float], k_ratio: float = 0.1
...
def benchmark_compression():
    ...
    for method, description in methods:
        compressor = GradientCompressor(
            compression_method=method, sparsity_ratio=0.1, quantize_bits=8
        )
...
if __name__ == "__main__":
    ...
    compressor = GradientCompressor(
        CompressionMethod.TOPK_QUANTIZE, sparsity_ratio=0.1, quantize_bits=8
    )
